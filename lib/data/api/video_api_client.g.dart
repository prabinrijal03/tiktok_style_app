...
class _VideoApiClient implements VideoApiClient {
  ...
  @override
  Future<List<VideoResponse>> getVideos(int limit) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'_limit': limit};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<VideoResponse>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    late List<VideoResponse> _value;
    try {
      _value = _result.data!
  ...
  @override
  Future<VideoResponse> getVideo(String id) async {
    final _extra = <String, dynamic>{};
